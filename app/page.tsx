      ...
      <SectionContainer className="bg-muted/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-card rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground mb-6">
              Discover my academic journey through astronomy.
            </p>
            <Link 
              href="/education" 
          ...
          <div className="bg-card rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground mb-6">
              Explore my research work in dynamics of planetary systems, stellar flybys, and protoplanetary disks.
            </p>
            <Link 
              href="/projects" 
              className="inline-flex items-center text-primary hover:text-primary/80 transition-colors"
          ...
          <div className="bg-card rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground mb-6">
              Have questions about me or my work? Feel free to reach out.
            </p>
            <Link 
              href="/contact" 
              className="inline-flex items-center text-primary hover:text-primary/80 transition-colors"
        ...
        <div className="text-center mt-12">
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Download my CV to learn more about my academic achievements, research experience, and professional skills.
          </p>
